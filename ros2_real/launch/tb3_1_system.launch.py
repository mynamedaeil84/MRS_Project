...
def generate_launch_description():
    ...
    ctrl_yaml_path = os.path.join(pkg_dir, 'config', 'tb3_1_controllers.yaml')

    urdf_path = os.path.join(pkg_dir, 'urdf', 'turtlebot3_waffle_pi_tb3_1.urdf')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            namespace=ns,
            parameters=[os.path.join(pkg_dir, 'config', 'tb3_1_controllers.yaml')],
            output='screen'
        ),
